...
public class PhoneBook {
	...
	public void addContact(String lastN, String firstN, String homeAdd,String phoneNo) {
	...
	public void searchContact(String searchedString) {
		...
		if (it > 1) {
			...
			System.out.println("Sorry, no contact was found containing this information");
		}
